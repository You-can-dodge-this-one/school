...
set(MSG_I_FLAGS "-Iserial_msgs:/home/mbot/mbot_ws/src/serial_msgs/msg")
...
get_filename_component(_filename "/home/mbot/mbot_ws/src/serial_msgs/msg/serial.msg" NAME_WE)
add_custom_target(_serial_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "serial_msgs" "/home/mbot/mbot_ws/src/serial_msgs/msg/serial.msg" ""
)
...
_generate_msg_cpp(serial_msgs
  "/home/mbot/mbot_ws/src/serial_msgs/msg/serial.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/serial_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/serial_msgs\")")
  # install generated code
  install(
